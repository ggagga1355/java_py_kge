...
public class Multi_array {
	...
	public static void main(String[] args) {
		...
		//첫번째 요소의 길이
		// scores[0] = {80,90,95};
		System.out.println(scores[0]); //값이 아닌 주소를 반환
		...
		int result = (scores[0][0] + scores[0][1] + scores[0][2])/scores[0].length;
		...
		//각 반의 학생수들의 점수 저장을 위한 2처원 배열생성하기
		//반은 3개 1-4,2-2,3-6
